...
do
mkdir replica_$i
cp example/readdata0.f replica_$i/readdata.f
cp example/example.f replica_$i/example.f
cp example/Makefile replica_$i/Makefile
cp example/run_fit.bash replica_$i/run_fit.bash
done
