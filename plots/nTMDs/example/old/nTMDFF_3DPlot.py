...
df3d = pd.read_csv('fort.4000', delimiter = ',',delim_whitespace=True)
...
ax.scatter(kt,z,PDF_P,color= "blue")
ax.set_xlabel(r"\rm $p_T$ (GeV)", fontsize = 25, labelpad = 20)
ax.set_ylabel(r"\rm $z$", fontsize = 25, labelpad = 20)
ax.zaxis.set_rotate_label(False)  # disable automatic rotation
ax.set_zlabel(r"\rm $z D_{\pi^0/p}$", fontsize = 25, labelpad = 20)
...
ax2.scatter(kt,z,PDF_1,color= "green")
ax2.set_xlabel(r"\rm $p_T$ (GeV)", fontsize = 25, labelpad = 20)
ax2.set_ylabel(r"\rm $z$", fontsize = 25, labelpad = 20)
ax2.zaxis.set_rotate_label(False)  # disable automatic rotation
ax2.set_zlabel(r"\rm $z D_{\pi^{0}/A}$", fontsize = 25, labelpad = 25)
...
ax4.scatter(kt,z,PDF_1/PDF_P,color= "green")
ax4.set_xlabel(r"\rm $p_T$ (GeV)", fontsize = 25, labelpad = 20)
ax4.set_ylabel(r"\rm $z$", fontsize = 25, labelpad = 20)
...
ax5.scatter(kt,z,PDF_2/PDF_P,color= "red")
ax5.set_xlabel(r"\rm $p_T$ (GeV)", fontsize = 25, labelpad = 20)
ax5.set_ylabel(r"\rm $z$", fontsize = 25, labelpad = 20)
