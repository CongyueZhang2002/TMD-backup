...
*-----Set Grid Directory Names
      nCTEQ15_HE_DIR = 'nCTEQ15HE/'
      nCTEQ15_CA_DIR = 'nCTEQ15CA/'
      nCTEQ15_NE_DIR = 'nCTEQ15NE/'
      nCTEQ15_KR_DIR = 'nCTEQ15KR/'
      nCTEQ15_XE_DIR = 'nCTEQ15XE/'
      nCTEQ15_BE_DIR = 'nCTEQ15BE/'
      nCTEQ15_FE_DIR = 'nCTEQ15FE/'
      nCTEQ15_WW_DIR = 'nCTEQ15WW/'
      nCTEQ15_JCC_DIR= 'nCTEQ15JCC/'
      nCTEQ15_JFE_DIR= 'nCTEQ15JFE/'
      nCTEQ15_JPB_DIR= 'nCTEQ15JPB/'
      nCTEQ15_LPB_DIR= 'nCTEQ15LPB/'
      nCTEQ15_AU_DIR = 'nCTEQ15AU/'

*-----GRID FILE NAMES:
      nCTEQ15_HE_GRIDS   = 'nCTEQ15HE_0000.dat'
      nCTEQ15_CA_GRIDS   = 'nCTEQ15CA_0000.dat'
      nCTEQ15_NE_GRIDS   = 'nCTEQ15NE_0000.dat'
      nCTEQ15_KR_GRIDS   = 'nCTEQ15KR_0000.dat'
      nCTEQ15_XE_GRIDS   = 'nCTEQ15XE_0000.dat'
      nCTEQ15_BE_GRIDS   = 'nCTEQ15BE_0000.dat'
      nCTEQ15_FE_GRIDS   = 'nCTEQ15FE_0000.dat'
      nCTEQ15_WW_GRIDS   = 'nCTEQ15WW_0000.dat'
      nCTEQ15_JCC_GRIDS  = 'nCTEQ15JCC_0000.dat'
      nCTEQ15_JFE_GRIDS  = 'nCTEQ15JFE_0000.dat'
      nCTEQ15_JPB_GRIDS  = 'nCTEQ15JPB_0000.dat'
      nCTEQ15_LPB_GRIDS  = 'nCTEQ15LPB_0000.dat'
      nCTEQ15_AU_GRIDS   = 'nCTEQ15AU_0000.dat'
...
C-----INITIALIZE PDF SETS USING LHAPDF
            ...
            CALL InitPDFM(1,0)
            print *, "2"
            CALL InitPDFsetByNameM(2,"nCTEQ15FullNuc_4_2")  !He
            CALL InitPDFM(2,0)
            print *, "3"
            CALL InitPDFsetByNameM(3,"nCTEQ15FullNuc_20_10") !Ne
            CALL InitPDFM(3,0)
            print *, "4"
            CALL InitPDFsetByNameM(4,"nCTEQ15FullNuc_84_42") !Kr
            CALL InitPDFM(4,0)
            print *, "5"
            CALL InitPDFsetByNameM(5,"nCTEQ15FullNuc_131_54") !Xe
            CALL InitPDFM(5,0)
            print *, "6"
            ...
            CALL InitPDFM(9,0)
            print *, "10"
            CALL InitPDFsetByNameM(10,"nCTEQ15FullNuc_9_4") ! Be
            CALL InitPDFM(10,0)
            print *, "11"
            CALL InitPDFsetByNameM(11,"nCTEQ15FullNuc_56_26") !Fe
            CALL InitPDFM(11,0)
            print *, "12"
            CALL InitPDFsetByNameM(12,"nCTEQ15FullNuc_184_74") ! W
            CALL InitPDFM(12,0)
            print *, "13"
            CALL InitPDFsetByNameM(13,"nCTEQ15FullNuc_12_6") ! C
            CALL InitPDFM(13,0)
            print *, "14"
            CALL InitPDFsetByNameM(14,"nCTEQ15FullNuc_56_26") ! Fe
            CALL InitPDFM(14,0)
            print *, "15"
            CALL InitPDFsetByNameM(15,"nCTEQ15FullNuc_208_82") ! Pb
            CALL InitPDFM(15,0)
            print *, "16"
      ...
      !      CALL InitPDFM(18,0)
            print *, "19"
            CALL InitPDFsetByNameM(19,"nCTEQ15FullNuc_208_82") ! Pb
            CALL InitPDFM(19,0)
            print *, "20"
            CALL InitPDFsetByNameM(20,"nCTEQ15FullNuc_197_79") ! Au
            CALL InitPDFM(20,0)
            print *, "21"
            CALL InitPDFsetByNameM(21,"CT14nlo") ! PR
            CALL InitPDFM(21,0)
            print *, "22"
            CALL InitPDFsetByNameM(22,"nCTEQ15FullNuc_40_20") ! Ca
            CALL InitPDFM(22,0)
            print *, "23"
