      ...
      CHARACTER*72 EPPS16_CA_DIR   ,EPPS16_CA_GRIDS
      CHARACTER*72 EPPS16_KR_DIR   ,EPPS16_KR_GRIDS
      CHARACTER*72 EPPS16_XE_DIR   ,EPPS16_XE_GRIDS
      CHARACTER*72 EPPS16_BE_DIR   ,EPPS16_BE_GRIDS
      CHARACTER*72 EPPS16_FE_DIR   ,EPPS16_FE_GRIDS
      CHARACTER*72 EPPS16_WW_DIR   ,EPPS16_WW_GRIDS
      CHARACTER*72 EPPS16_JCC_DIR  ,EPPS16_JCC_GRIDS
      CHARACTER*72 EPPS16_JFE_DIR  ,EPPS16_JFE_GRIDS
      CHARACTER*72 EPPS16_JPB_DIR  ,EPPS16_JPB_GRIDS
      CHARACTER*72 EPPS16_LPB_DIR  ,EPPS16_LPB_GRIDS
      CHARACTER*72 EPPS16_AU_DIR   ,EPPS16_AU_GRIDS
      CHARACTER*72 EPPS16_PR_DIR   ,EPPS16_PR_GRIDS
...
*-----Set Grid Directory Names
      EPPS16_PR_DIR = 'EPPS16PR/'
      EPPS16_HE_DIR = 'EPPS16HE/'
      EPPS16_CA_DIR = 'EPPS16CA/'
      EPPS16_NE_DIR = 'EPPS16NE/'
      EPPS16_KR_DIR = 'EPPS16KR/'
      EPPS16_XE_DIR = 'EPPS16XE/'
      EPPS16_BE_DIR = 'EPPS16BE/'
      EPPS16_FE_DIR = 'EPPS16FE/'
      EPPS16_WW_DIR = 'EPPS16WW/'
      EPPS16_JCC_DIR= 'EPPS16JCC/'
      EPPS16_JFE_DIR= 'EPPS16JFE/'
      EPPS16_JPB_DIR= 'EPPS16JPB/'
      EPPS16_LPB_DIR= 'EPPS16LPB/'
      EPPS16_AU_DIR = 'EPPS16AU/'

*-----GRID FILE NAMES:
      EPPS16_PR_GRIDS   = 'EPPS16PR_0000.dat'
      EPPS16_HE_GRIDS   = 'EPPS16HE_0000.dat'
      EPPS16_CA_GRIDS   = 'EPPS16CA_0000.dat'
      EPPS16_NE_GRIDS   = 'EPPS16NE_0000.dat'
      EPPS16_KR_GRIDS   = 'EPPS16KR_0000.dat'
      EPPS16_XE_GRIDS   = 'EPPS16XE_0000.dat'
      EPPS16_BE_GRIDS   = 'EPPS16BE_0000.dat'
      EPPS16_FE_GRIDS   = 'EPPS16FE_0000.dat'
      EPPS16_WW_GRIDS   = 'EPPS16WW_0000.dat'
      EPPS16_JCC_GRIDS  = 'EPPS16JCC_0000.dat'
      EPPS16_JFE_GRIDS  = 'EPPS16JFE_0000.dat'
      EPPS16_JPB_GRIDS  = 'EPPS16JPB_0000.dat'
      EPPS16_LPB_GRIDS  = 'EPPS16LPB_0000.dat'
      EPPS16_AU_GRIDS   = 'EPPS16AU_0000.dat'

C-------PR

      IF (I_PR.eq.1) THEN

        INQUIRE(FILE=EPPS16_PR_DIR, EXIST=DIRECTORY_EXISTS)
        IF (.not.DIRECTORY_EXISTS) THEN
            CALL SYSTEM(MKDIR//EPPS16_PR_DIR)
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_PR_DIR)//EPPS16_PR_GRIDS)
...
C-------CA
      ...
      Z = 20
        ...
        INQUIRE(FILE=EPPS16_CA_DIR, EXIST=DIRECTORY_EXISTS)
        IF (.not.DIRECTORY_EXISTS) THEN
            CALL SYSTEM(MKDIR//EPPS16_CA_DIR)
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_CA_DIR)//EPPS16_CA_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
        ...
        DO I = 1, NXB
          ...
          DO J = 1, NQQ
            Q = QQ(J)
            print *, "CA",x, Q
            call PDF_A_EPPS16(x,Q,A,Z,U,D,UB,DB,S,SB,G,nloops)
            WRITE(4,103) x*SB,x*UB,x*DB,x*D,x*U,x*S,x*G
          ENDDO
        ENDDO
...
C-------HE
      ...
      Z = 2
        ...
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_HE_DIR)//EPPS16_HE_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
...
C-------NE
      ...
      Z = 10
        ...
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_NE_DIR)//EPPS16_NE_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
...
C-------KR
      ...
      Z = 36
        ...
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_KR_DIR)//EPPS16_KR_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
...
C-------XE
      ...
      Z = 54
        ...
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_XE_DIR)//EPPS16_XE_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
...
C-------BE
      ...
      Z = 4
        ...
        INQUIRE(FILE=EPPS16_BE_DIR, EXIST=DIRECTORY_EXISTS)
        IF (.not.DIRECTORY_EXISTS) THEN
            CALL SYSTEM(MKDIR//EPPS16_HE_DIR)
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_BE_DIR)//EPPS16_BE_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
...
C-------FE
      ...
      Z = 26
        ...
        INQUIRE(FILE=EPPS16_FE_DIR, EXIST=DIRECTORY_EXISTS)
        IF (.not.DIRECTORY_EXISTS) THEN
            CALL SYSTEM(MKDIR//EPPS16_HE_DIR)
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_FE_DIR)//EPPS16_FE_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
...
C-------WW
      ...
      Z = 74
        ...
        INQUIRE(FILE=EPPS16_WW_DIR, EXIST=DIRECTORY_EXISTS)
        IF (.not.DIRECTORY_EXISTS) THEN
            CALL SYSTEM(MKDIR//EPPS16_HE_DIR)
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_WW_DIR)//EPPS16_WW_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
...
C-------JLAB C
      ...
      Z = 6
        ...
        INQUIRE(FILE=EPPS16_JCC_DIR, EXIST=DIRECTORY_EXISTS)
        IF (.not.DIRECTORY_EXISTS) THEN
            CALL SYSTEM(MKDIR//EPPS16_JCC_DIR)
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_JCC_DIR)//EPPS16_JCC_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
...
C-------JLAB FE
      ...
      Z = 26
        ...
        INQUIRE(FILE=EPPS16_JFE_DIR, EXIST=DIRECTORY_EXISTS)
        IF (.not.DIRECTORY_EXISTS) THEN
            CALL SYSTEM(MKDIR//EPPS16_JFE_DIR)
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_JFE_DIR)//EPPS16_JFE_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
...
C-------JLAB PB
      ...
      Z = 82
        ...
        INQUIRE(FILE=EPPS16_JPB_DIR, EXIST=DIRECTORY_EXISTS)
        IF (.not.DIRECTORY_EXISTS) THEN
            CALL SYSTEM(MKDIR//EPPS16_JPB_DIR)
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_JPB_DIR)//EPPS16_JPB_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
...
C-------CMS PB
      ...
      Z = 82
        ...
        INQUIRE(FILE=EPPS16_LPB_DIR, EXIST=DIRECTORY_EXISTS)
        IF (.not.DIRECTORY_EXISTS) THEN
            CALL SYSTEM(MKDIR//EPPS16_LPB_DIR)
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_LPB_DIR)//EPPS16_LPB_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
      ...
      Z = 79
        ...
        INQUIRE(FILE=EPPS16_AU_DIR, EXIST=DIRECTORY_EXISTS)
        IF (.not.DIRECTORY_EXISTS) THEN
            CALL SYSTEM(MKDIR//EPPS16_AU_DIR)
        ENDIF
*-------Generate LHAPDF Grids
        OPEN(UNIT = 4, FILE = trim(EPPS16_AU_DIR)//EPPS16_AU_GRIDS)
        WRITE(4,*) 'PdfType: central'
        WRITE(4,*) 'Format: lhagrid1'
        WRITE(4,*) '---'
        WRITE(4,100) XB
