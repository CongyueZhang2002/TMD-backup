...
c--------------------------------------------------------------
      ...
      integer IT,nloops,hop,nll,prepdf,preff
      integer IH,IC
      integer A_FE
      real*8 Q02, Qaux
...
*--------Calculated TMDPDF for proton
      ...
      elseif(IT.eq.4) then        ! helium target
          ...
          !if (xb.lt.0.355d0) then
            ...
            call PDF_A_EPPS16(xb,Q0,IT,2,U,D,UB,DB,SS,SB,GL,nloops)
            !                       (A,Z)
            endif
      elseif(IT.eq.12) then        ! carbon target
        ...
        !if (xb.lt.0.355d0) then
          ...
          call PDF_A_EPPS16(xb,Q0,IT,6,U,D,UB,DB,SS,SB,GL,nloops)
          !                      (A,Z)
          endif
      elseif(IT.eq.20) then        ! neon target
        ...
        !  if (xb.lt.0.355d0) then
            ...
            call PDF_A_EPPS16(xb,Q0,IT,10,U,D,UB,DB,SS,SB,GL,nloops)
            !                      (A,Z)
            endif
      elseif(IT.eq.56) then        ! iron target
          ...
          if (prepdf.eq.1) then
            ...
            call PDF_A_EPPS16(xb,Q0,IT,26,U,D,UB,DB,SS,SB,GL,nloops)
            !                      (A,Z)
          endif
      elseif(IT.eq.84) then        ! krypton target
          ...
          call PDF_A_EPPS16(xb,Q0,IT,36,U,D,UB,DB,SS,SB,GL,nloops)
          endif
      elseif(IT.eq.131) then        ! xenon target
          ...
          call PDF_A_EPPS16(xb,Q0,IT,54,U,D,UB,DB,SS,SB,GL,nloops)
          endif
      elseif(IT.eq.197) then        ! Gold target
          ...
          call PDF_A_EPPS16(xb,Q0,IT,79,U,D,UB,DB,SS,SB,GL,nloops)
          endif
      elseif(IT.eq.208) then        ! lead target
          ...
          call PDF_A_EPPS16(xb,Q0,IT,82,U,D,UB,DB,SS,SB,GL,nloops)
          endif
       endif
