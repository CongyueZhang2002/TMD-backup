...
C-----LOWER BOUND (LIMIT) ON PARAMETER VALUE, IF ANY
      data BL   /-0.086, -0.034, -10.0, -10.0, -10.0, -10.0/ ! chaneg parameters
...
*.....CALCULATE THE STARTING TIME OF THE FIT
      ...
      print*, XX(1),XX(2),XX(3),XX(4),XX(5),XX(6),chi2, chi2/27d0
      do while( (chi2/27d0 .GT. 850d0) .OR. (isNAN(chi2)) )
