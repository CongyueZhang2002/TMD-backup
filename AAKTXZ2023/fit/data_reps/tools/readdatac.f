     ...
     $       X16(3000), X17(3000), X18(3000), X19(3000), X20(3000)
      ...
      INTEGER NLINES,NTOT,NTOT2,I, NTOT_JLAB
      include "./data-inc.f"
      CHARACTER*8 rt
...
C-----REPLICA #
      NLINES = 1
      NTOT = 1
      FILEEXP = rt//'collected_results.csv'
      CALL READDATA13(FILEEXP,NLINES,
     ...
     >                    X12, X13, NTOT)
      ...
      NLINES = 1
      NTOT_JLAB = 180
      FILEEXP = RT//'SIDIS/JLAB12_DIS/JLAB_piplus.dat'
      CALL READDATA9(FILEEXP,NLINES,X1,X2,X3,X4,X5,
     *                    X6, X7, X8, X9, NTOT_JLAB)
      DO I=1,NTOT_JLAB
      ...
      NLINES = 1
      NTOT_JLAB = 150
      FILEEXP = RT//'SIDIS/JLAB12_DIS/JLAB_piminus.dat'
      CALL READDATA9(FILEEXP,NLINES,X1,X2,X3,X4,X5,
     *                    X6, X7, X8, X9, NTOT_JLAB)
      DO I=1,NTOT_JLAB
...
C------- JLAB
     ...
     *                     X14, X15, X16, X17, X18, X19, NTOT)
      ...
      EIC_PRED_DIS  = 1.0246426993914302
      EICC_PRED_DIS = 1.0238773746382241
      JLAB_PRED_DIS = 0.89577093966260513
...
c     read data file which has 13 columns
c-----------------------------------------
      SUBROUTINE READDATA12(FILEEXP,NLINES,X1,
     $           X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12, NTOT)
      CHARACTER*72 FILEEXP,LINE
      REAL*8 X1(100),X2(100),X3(100),X4(100),X5(100),X6(100)
      REAL*8 X7(100),X8(100),X9(100),X10(100),X11(100),X12(100)
      INTEGER NLINES,NTOT,I,NT
