...
C-----------------------------------------
      INTEGER I_JLAB_PRED, I_EIC_PRED, I_EICC_PRED
      INTEGER I_x_PRED
      INTEGER I_z_PRED
      INTEGER I_pht_PRED
...
C-----EIC,EICC,JLAB
      REAL*8 :: EIC_PRED_Qs(30),EIC_PRED_xb(30),EIC_PRED_dis(30)
      COMMON /EIC_PRED/ EIC_PRED_Qs,EIC_PRED_xb, EIC_PRED_dis

      REAL*8 :: EICC_PRED_Qs(30),EICC_PRED_xb(30),EICC_PRED_dis(30)
      COMMON /EICC_PRED/ EICC_PRED_Qs,EICC_PRED_xb, EICC_PRED_dis 

      REAL*8 :: JLAB_PRED_Qs(30),JLAB_PRED_xb(30),JLAB_PRED_dis(30)
      COMMON /JLAB_PRED/ JLAB_PRED_Qs,JLAB_PRED_xb, JLAB_PRED_dis 
...
C------KEY: (HADRON)_(NUCLEUS)_(VARIABLE)_(DATA)
C------HADRON: PIP, PI0, PIM, KP, KM, P, PB.
C------NUCLEUS: HE, NE, KR, XE
C------VARIABLE: NU, Z, Q2, PT2
C------DATA: VALUE, MULT, STAT, SYS
...
C--------------- LHC (CMS) p + pB --> muons
      REAL*8 ::           LHC_PT(2), LHC_CX(2), LHC_ERR(2),
     *                    LHC_YLOW(2), LHC_YHIGH(2), LHC_QLOW(2),
     *                    LHC_QHIGH(2)

      COMMON /LHC_CMS/    LHC_PT, LHC_CX, LHC_ERR,
     *                    LHC_YLOW, LHC_YHIGH, LHC_QLOW, LHC_QHIGH
...
C------ ALL DATA
     ...
     $ I_PI0_XE_PT2,  I_CLAS1, I_CLAS2, I_CLAS3, I_CLAS4, I_CLAS5,
     $ I_CLAS6, I_CLAS7, I_CLAS8, I_CLAS9, I_LHC, I_JLAB_PIP_12,
     $ I_JLAB_PIM_12, I_JLAB_PRED, I_EIC_PRED, I_EICC_PRED,
     $ I_x_PRED, I_z_PRED, I_pht_PRED,
     $ I_pip_2022, I_pim_2022
