...
C                      compatibility with the EPS09/EPPS21 routine
C
C
C     pset (integer):
C            1       = central fit
...
C Read the table
        ...
        If (A < 10) Then
        Write(filenimi,'("../fit/TMDs/grids/EPPS21NLOR_", I1)'), A
        Else If (A < 100) Then
        Write(filenimi,'("../fit/TMDs/grids/EPPS21NLOR_", I2)'), A
        Else If (A < 1000) Then
        Write(filenimi,'("../fit/TMDs/grids/EPPS21NLOR_", I3)'), A
        End If
