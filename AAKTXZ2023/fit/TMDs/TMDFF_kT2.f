...
C-----1: u   2:  d    3: s   4: ub   5: db   6: sb
      ...
      !write(1010,*) qFFb(1d0)
      call adogt(qFFb,kt,Q,0,x,98d0,part) !call adogt(qFFb,kt/ x,Q,0,1d0,60d0,part)
...
! modification
     ...
     >     bmax,ktw,ptw,Qini,kappa2
      ...
      kappa1 = (widff/4/(x*x))
      corff = 0.5*g3D*(AA**(1d0/3d0)-1d0)*b*b*(1/Q)**gamma !2023
     ...
     &           corff/(x*x)) !2023
      ...
      if (AA.eq.1) then
      nloops = 2
            call FF_vacuum(x,Q00,fu,fub,fd,fdb,fs,fsb,fg,nloops) !2023
      else
      
            call Nuclear_TMDFF(x,Q00,AA,fu,fub,fd,fdb,fs,fsb,fg,nloops) !2023
      endif
