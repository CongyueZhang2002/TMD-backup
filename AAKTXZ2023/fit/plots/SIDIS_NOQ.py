...
multplot_pip_he_pt2.newaxesplot(axs[0,2],0.4,1.4)
multplot_pip_he_pt2.axesplot(axs[0,2])
multplot_pip_ne_pt2.axesplot(axs[0,2])
multplot_pip_xe_pt2.axesplot(axs[0,2])
...
multplot_pi0_he_pt2.newaxesplot(axs[1,2],0.4,1.4)
multplot_pi0_he_pt2.axesplot(axs[1,2])
multplot_pi0_ne_pt2.axesplot(axs[1,2])
multplot_pi0_kr_pt2.axesplot(axs[1,2])
multplot_pi0_xe_pt2.axesplot(axs[1,2])
...
multplot_pim_he_pt2.newaxesplot(axs[2,2],0.4,1.4)
multplot_pim_he_pt2.axesplot(axs[2,2])
multplot_pim_ne_pt2.axesplot(axs[2,2])
multplot_pim_kr_pt2.axesplot(axs[2,2])
multplot_pim_xe_pt2.axesplot(axs[2,2])
...
axs[2,2].set_xlabel(r"\rm $p_t^2$ (Ge$V^2$)", fontsize = 30, labelpad = 10)
...
fig.savefig('SIDIS_PIONS.pdf', bbox_inches = "tight")
