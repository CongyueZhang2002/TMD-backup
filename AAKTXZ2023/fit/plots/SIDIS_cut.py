...
class multdata:
    ...
    def __init__(self, file, var):
        file = file[(file.pt2<0.7) & (file.Z<0.7)& (np.sqrt(file.pt2)/(np.sqrt(file.Q2)*file.Z)<0.75)]
        self.xdata  = file[var]
        self.var    = var
        self.nu     = file['Nu']
        self.z      = file['Z']
        ...
        self.stat   = file['STAT']
        self.sys    = file['SYS']
        self.Ra     = file['fuua']/file['fuu']/file['DIS']
...
#pip
multplot_pip_he_q2.newaxesplot(axs[0,0],0.4,1.4)
multplot_pip_he_q2.axesplot(axs[0,0])
multplot_pip_ne_q2.axesplot(axs[0,0])
multplot_pip_kr_q2.axesplot(axs[0,0])
multplot_pip_xe_q2.axesplot(axs[0,0])

multplot_pip_he_pt2.newaxesplot(axs[0,1],0.4,1.4)
multplot_pip_he_pt2.axesplot(axs[0,1])
multplot_pip_ne_pt2.axesplot(axs[0,1])
multplot_pip_xe_pt2.axesplot(axs[0,1])

#pi0
multplot_pi0_he_q2.newaxesplot(axs[1,0],0.4,1.4)
multplot_pi0_he_q2.axesplot(axs[1,0])
multplot_pi0_ne_q2.axesplot(axs[1,0])
multplot_pi0_kr_q2.axesplot(axs[1,0])
multplot_pi0_xe_q2.axesplot(axs[1,0])

multplot_pi0_he_pt2.newaxesplot(axs[1,1],0.4,1.4)
multplot_pi0_he_pt2.axesplot(axs[1,1])
multplot_pi0_ne_pt2.axesplot(axs[1,1])
multplot_pi0_kr_pt2.axesplot(axs[1,1])
multplot_pi0_xe_pt2.axesplot(axs[1,1])

#pim
multplot_pim_he_q2.newaxesplot(axs[2,0],0.4,1.4)
multplot_pim_he_q2.axesplot(axs[2,0])
multplot_pim_ne_q2.axesplot(axs[2,0])
multplot_pim_kr_q2.axesplot(axs[2,0])
multplot_pim_xe_q2.axesplot(axs[2,0])

multplot_pim_he_pt2.newaxesplot(axs[2,1],0.4,1.4)
multplot_pim_he_pt2.axesplot(axs[2,1])
multplot_pim_ne_pt2.axesplot(axs[2,1])
multplot_pim_kr_pt2.axesplot(axs[2,1])
multplot_pim_xe_pt2.axesplot(axs[2,1])
...
axs[2,0].set_xlabel(r"\rm $Q^2$ (Ge$V^2$)", fontsize = 30, labelpad = 10)
axs[2,1].set_xlabel(r"\rm $p_t^2$ (Ge$V^2$)", fontsize = 30, labelpad = 10)
...
axs[2,1].legend(frameon = False,fontsize = 25,loc='upper center', bbox_to_anchor=(1.2, 0.9))
